...
class ArticlesController extends Controller
{
    ...
    {
        $noticias = Article::with('images')->orderBy('created_at', 'DESC')->get();
    ...
    {
        $noticias = Article::with('images')->orderBy('created_at', 'DESC')->take(3)->get();

        return response()->json($noticias);
    }

    public function getNoticiasDestacadas()
    {
        $noticias = Article::with('images')->inRandomOrder()->take(3)->get();
    ...
    // {
    //     $noticia = Article::with('images')->find($id);
    ...
    {
        $noticia = Article::with('images')->where('slug', $slug)->first();
